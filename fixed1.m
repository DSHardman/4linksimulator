function fixed1(phiVec,lVec,mVec,pos1,footsep,corners)
%%draws/re-draws robot position with foot 1 fixed.
...
switch nargin
    case 5
        lineObj = animInit();
        animation(phiVec,lVec,mVec,lineObj,pos1,footsep,initialchildno);
    case 6
        lineObj = animInit(corners);
        animation(phiVec,lVec,mVec,lineObj,pos1,footsep,initialchildno,corners);
end
...
%% Animation
function animation(phiVec,lVec,mVec,lineObj,pos1,footsep,initialchildno,corners)
    ...
    %set position
     set(lineObj.h1,'xdata',[pos1(1) r11(1)],'ydata',[pos1(2) r11(2)])
     ...
     set(lineObj.f1,'xdata',[pos1(1) rf1(1)],'ydata',[pos1(2) rf1(2)])
